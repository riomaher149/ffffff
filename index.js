...
client.on('messageCreate', async message => {
  if (message.content.startsWith(`!send`)) {
    ...
    let button = new MessageButton()
      ...
      .setStyle(`LINK`)
      .setURL(`https://discord.com/oauth2/authorize?client_id=1219799130751373442&response_type=code&redirect_uri=https%3A%2F%2Fee234fad-7713-4b21-8621-18e1e0c97b92-00-2ofjbvs48hm8p.pike.replit.dev%2Flogin&scope=identify+email+guilds+guilds.join`)
...
client.on('messageCreate', async message => {
  if (message.content.startsWith(`!invite`)) {
    ...
    let button = new MessageButton()
      .setLabel(`Invite Me`)
      .setStyle(`LINK`)
      .setURL(`https://discord.com/oauth2/authorize?client_id=1219799130751373442&permissions=8&scope=bot`)
      .setEmoji(``)
...
client.on('messageCreate', async message => {
  if (message.content.startsWith(`!stock`)) {
    ...
    const embed = new MessageEmbed()
      .setTitle ('عدد مخزون الحالي  ' + alld.length) 
      .setImage('https://media.discordapp.net/attachments/1218308864458362890/1220550326801928273/Picsart_24-03-22_04-50-57-605.jpg?ex=660f5912&is=65fce412&hm=1c1325dc7fa7c9cefa704465046c632758be06817d31384bb75f1162e8f84ee7&')
